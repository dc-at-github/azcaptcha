...
class TextToImage {
     ...
     */
    function createImage($text, $fontSize = 24, $imgWidth = 150, $imgHeight = 40){
        ...
        foreach($splitText as $txt){
            ...
            $x = (int)((imagesx($this->img) - $textWidth)/2);
            $y = (int)((((imagesy($this->img) + $textHeight)/2)-($lines-2)*$textHeight)/2);
            $lines = $lines-1;
